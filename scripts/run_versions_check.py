...
def check_remote_versions():
    ...
    try:
        ...
        sftp = ssh.open_sftp()
        sftp.put('scripts/check_versions.py', f'{project_path}/scripts/check_versions.py')
        sftp.close()
        
        stdin, stdout, stderr = ssh.exec_command(f"python3 {project_path}/scripts/check_versions.py")
